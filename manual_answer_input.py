...
class ManualAnswerInput:
    ...
    def scan_exam_directory(self, exam_dir: str) -> List[Dict[str, str]]:
        ...
        # Find all problem images (not diagram/content images)
    ...
    def extract_exam_metadata(self, exam_name: str) -> Dict[str, str]:
        ...
        exam_metadata = {
            ...
            'curriculum': metadata.get('curriculum', '2015개정'),
    ...
    def input_answers_for_exam(self, exam_dir: str) -> bool:
        ...
        try:
            ...
            print(f"🎓 Curriculum: {exam_metadata['curriculum']}")
                ...
                problem_record = {
                    ...
                    **exam_metadata,
                    'source_info': {
                        ...
                        'manual_input': True,
                        'input_timestamp': self.db_saver.validate_problem_data({'content': 'temp'})['created_at']
                    },
                    'tags': ['manual_input'],
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  # Input answers for specific exam
  ...
  python manual_answer_input.py --exam 2020-12-03_suneung
"""
    )
